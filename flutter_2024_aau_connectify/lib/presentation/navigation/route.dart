...
import 'package:flutter_2024_aau_connectify/presentation/screens/sign_up_page/verify_email.dart';
import 'package:flutter_2024_aau_connectify/presentation/screens/sign_up_page/verify_student.dart';
...
const String verifyStudentRoute = '/verify_student';
...
Route<dynamic> controller(RouteSettings settings) {
  switch (settings.name) {
    ...
    case verifyStudentRoute:
      return MaterialPageRoute(builder: (context) => const SignUpVerify());
